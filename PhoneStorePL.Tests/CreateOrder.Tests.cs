...
public class OrderTests
{
    ...
    //     Customer customer = new(3, "Messi", "0912323233", "HN");
    //     Staff seller = new(4, "Tran Tien Anh", "0902126092", "seller01", "abc123", "Hanoi", StaffEnum.Role.Seller, StaffEnum.Status.Active);
    //     PhoneDetail iphone14 = new(46, new Phone(0, "", new Brand(0, "", ""), "", "", "", "", "", "", "", "", "", new DateTime(), "", new Staff(0, "", "", "", "", "", StaffEnum.Role.Seller, StaffEnum.Status.Active), new DateTime(), ""), new ROMSize(0, ""), new PhoneColor(0, ""), 0, 0, PhoneEnum.Status.Type1, new Staff(0, "", "", "", "", "", StaffEnum.Role.Seller, StaffEnum.Status.Active), new DateTime());
