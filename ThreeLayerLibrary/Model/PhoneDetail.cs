...
public class PhoneDetail
{
    ...
    public PhoneDetail(int phoneDetailID, Phone phone, ROMSize romSize, PhoneColor phoneColor,decimal price, PhoneEnum.Status phoneStatusType, List<Imei> listImei, Staff updateBy, DateTime updateAt)
    {
